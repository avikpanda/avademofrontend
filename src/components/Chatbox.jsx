    ...
    stringAvatarChild: {
        ...
        border: ({ side }) =>
            `${theme.typography.pxToRem(1)} solid ${
                side === "left" ? theme.palette.primary.light : theme.palette.secondary.dark
            }`
    },
    elementAvatarChild: {
		...
		<Grow in >
			...
			>
					...
					>
						...
						{avatarTitle && (
							<Typography
								className={defaultStyle.avatarTitle}
							>
								{avatarTitle}
							</Typography>
						)}
						...
						{timestamp && (
							<>
								<div
									className={
										defaultStyle.timestampSeparator}
								/>

								<Typography
									className={defaultStyle.timestamp}
				...
				>
					{text && (
						<Pulse>
							<Typography
								className={{
									[defaultStyle.chatTextRight]:
										side === "right",
									[defaultStyle.chatTextLeft]:
										side === "left"
								}}
							>
								{text}
